...
export function StaleBanner() {
  ...
  return (
    <div className="absolute top-2 left-1/2 -translate-x-1/2 z-10 rounded-md px-3 py-1.5 text-xs font-medium bg-yellow-900/80 text-yellow-200 backdrop-blur-sm">
